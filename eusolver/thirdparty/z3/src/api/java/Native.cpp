...
DLL_VIS JNIEXPORT jstring JNICALL Java_com_microsoft_z3_Native_INTERNALgoalToDimacsString(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jboolean a2) {
  Z3_string result = Z3_goal_to_dimacs_string((Z3_context)a0, (Z3_goal)a1, (bool)a2);
  return jenv->NewStringUTF(result);
}
...
DLL_VIS JNIEXPORT jint JNICALL Java_com_microsoft_z3_Native_INTERNALsolverPropagateRegister(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jlong a2) {
  unsigned result = Z3_solver_propagate_register((Z3_context)a0, (Z3_solver)a1, (Z3_ast)a2);
  return (jint) result;
}
DLL_VIS JNIEXPORT void JNICALL Java_com_microsoft_z3_Native_INTERNALsolverPropagateConsequence(JNIEnv * jenv, jclass cls, jlong a0, jlong a1, jint a2, jintArray a3, jint a4, jintArray a5, jintArray a6, jlong a7) {
  unsigned * _a3 = (unsigned*) jenv->GetIntArrayElements(a3, NULL);
  unsigned * _a5 = (unsigned*) jenv->GetIntArrayElements(a5, NULL);
  unsigned * _a6 = (unsigned*) jenv->GetIntArrayElements(a6, NULL);
  Z3_solver_propagate_consequence((Z3_context)a0, (Z3_solver_callback)a1, (unsigned)a2, _a3, (unsigned)a4, _a5, _a6, (Z3_ast)a7);
  jenv->ReleaseIntArrayElements(a3, (jint*)_a3, JNI_ABORT);
  jenv->ReleaseIntArrayElements(a5, (jint*)_a5, JNI_ABORT);
  jenv->ReleaseIntArrayElements(a6, (jint*)_a6, JNI_ABORT);
}
