...
public final class Native {
  ...
  static {
    if (null == System.getProperty("z3.skipLibraryLoad")) {
      try {
  ...
  protected static native int INTERNALsolverPropagateRegister(long a0, long a1, long a2);
  protected static native void INTERNALsolverPropagateConsequence(long a0, long a1, int a2, int[] a3, int a4, int[] a5, int[] a6, long a7);
  ...
  public static int solverPropagateRegister(long a0, long a1, long a2) throws Z3Exception
  {
      int res = INTERNALsolverPropagateRegister(a0, a1, a2);
      Z3_error_code err = Z3_error_code.fromInt(INTERNALgetErrorCode(a0));
      if (err != Z3_error_code.Z3_OK)
          throw new Z3Exception(INTERNALgetErrorMsg(a0, err.toInt()));
      return res;
  ...
  public static void solverPropagateConsequence(long a0, long a1, int a2, int[] a3, int a4, int[] a5, int[] a6, long a7) throws Z3Exception
  {
